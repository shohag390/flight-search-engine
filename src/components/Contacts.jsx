...
const Contacts = () => {
  return (
    ...
    >
      ...
      <div className="pt-4 md:pt-5 lg:pt-6 2xl:pt-7 pb-11 md:pb-12 lg:pb-13 2xl:pb-14 w-full lg:w-[70%] mx-auto grid grid-cols-1 md:grid-cols-3 gap-5">
      ...
      <div className="w-full h-75 md:h-100 lg:h-125 overflow-hidden rounded-lg">
        <iframe
      ...
      <div className="flex flex-col lg:flex-row gap-5 lg:gap-10 w-full pt-10 md:pt-15 lg:pt-20">
        ...
        <form className="bg-gray-100 flex flex-col items-center justify-center p-4 md:p-5 lg:p-6 2xl:p-7 w-full lg:w-[50%] rounded-md">
          <div className="w-full flex justify-between gap-5 flex-col">
            ...
            <button className="bg-[#1DC6CB] text-[#ffff] hover:bg-[#FEBB76] duration-500 active:scale-1.2 px-9 py-3 rounded-md">
              Send Message
            </button>
          </div>
        </form>
